/*
 * Copyright (C) 2013 - 2015 Adrian Ulrich <adrian@apesin.ch>
 *
...
public class MirrorLinkMediaBrowserService extends MediaBrowserService
	...
	private static final String CUSTOM_ACTION_REPEAT = "ch.apesin.android.ap.REPEAT";
	// Action to change the repeat mode
	private static final String CUSTOM_ACTION_SHUFFLE = "ch.apesin.android.ap.SHUFFLE";
		...
		mMediaRoot.add(new MediaBrowser.MediaItem(
				new MediaDescription.Builder()
					...
					.setIconUri(Uri.parse("android.resource://" +
							"ch.apesin.android.ap/drawable/ic_menu_music_library"))
