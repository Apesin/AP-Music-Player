/*
 * Copyright (C) 2015-2017 Adrian Ulrich <adrian@apesin.ch>
 *
...
public class CoverCache {
	...
	/**
	 * Use ap musics cover load mechanism
	 */
	public static final int COVER_MODE_VANILLA = 0x2;
	/**
	 * Use ap musics SHADOW cover load mechanism
	 */
	public static final int COVER_MODE_SHADOW = 0x4;
	/**
	 * Use ap musics INLINE cover load mechanism
	 */
		...
		public Bitmap createBitmap(Context ctx, Song song, long maxPxCount) {
			...
			try {
				...
				if (inputStream == null && (CoverCache.mCoverLoadMode & CoverCache.COVER_MODE_SHADOW) != 0) {
					final String shadowBase = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC).getPath() + "/.ap";
