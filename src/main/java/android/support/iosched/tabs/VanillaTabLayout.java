/*
 * Copyright (C) 2015-2016 Adrian Ulrich <adrian@apesin.ch>
 *
...
public class VanillaTabLayout extends SlidingTabLayout {
	...
	public VanillaTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setSelectedIndicatorColors(context.getResources().getColor(ch.apesin.android.ap.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		view.setTextColor(getResources().getColorStateList(ch.apesin.android.ap.R.color.tab_text_selector));
		view.setBackgroundResource(ch.apesin.android.ap.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
